...
; Explanation :
;  
; Use         : IDL> res = PIXCARR(indices,nax1,nax2,cd1,cd2,cenx,ceny,rsun,dateo[,fixl0=fixl0])             
;
...
;               FIXL0 = 90. will allow to compute heliographic coordinates
;               (substract 90 to the result) 
;
;
...
FUNCTION PIX2CARR,tab,nax1,nax2,cd1,cd2,cenx,ceny,rsun,dateo,FIXL0=fixl0
